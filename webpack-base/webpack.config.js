...
module.exports = {
  ...
  devServer: {
    //概念扫盲https://blog.csdn.net/qq_17175013/article/details/119213124
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        use: {
          loader: 'babel-loader', //扫盲http://www.voycn.com/article/babel-loaderbabel-corehebabel-presetzhijianshishenmeguanxi
          options: {
      ...
      },
      {
        ...
        type: 'asset/resource', //扫盲https://blog.csdn.net/qq_15601471/article/details/115083790
      },
    ],
  },
  plugins: [
